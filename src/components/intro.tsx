  ...
  return (
    ...
    >
      <div className="font-light text-3xl flex flex-col clamp gap-2">
        ...
        <span>
          i&apos;m{" "}
          <b className="text-[--main-fucsia] font-medium">MICHAEL CECCHINI</b>
        </span>
        <p className="border-r-[.10em] border-r-[--main-fucsia] whitespace-nowrap overflow-hidden mt-0 mb-0 ml-auto mr-auto typing">
