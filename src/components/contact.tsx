...
export default function Contact() {
  ...
  const sendEmail = async () => {
    document.getElementById("email-form")!.style.filter =
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const name = (form.elements.namedItem("your_name") as HTMLInputElement)
      .value;
    const email = (form.elements.namedItem("your_email") as HTMLInputElement)
      .value;
    ...
    >
      ...
      >
        <div className="fields-cont">
          ...
          <span className="field-errors" id="nameErr">
            {errors.nameErr}
          </span>
          <input
            type="text"
            ...
            name="your_name"
            id="nome"
            className={errors.nameErr ? "invalid" : ""}
          />
        </div>
        <div className="fields-cont">
          <span className="field-name">Email</span>
          <span className="field-errors" id="mailErr">
            {errors.mailErr}
          </span>
          <input
            type="text"
            ...
            name="your_email"
            id="email"
            className={errors.mailErr ? "invalid" : ""}
          />
        </div>
        <div className="fields-cont">
          <span className="field-name">Message</span>
          <span className="field-errors" id="msgErr">
            {errors.msgErr}
          </span>
          <textarea
      ...
      <div className="flex w-[90%] justify-center gap-10 items-center p-5 social-cont">
        <a
          href="https://instagram.com/___cecco___"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://www.threads.net/@___cecco___"
          target="_blank"
          rel="noreferrer"
        >
          <Image
